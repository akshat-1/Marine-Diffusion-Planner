...
if __name__ == "__main__":
    ...
    parser.add_argument("--raw-dir", type=str, default="./run_saved/raw_ais_downloads", help="Local directory to store raw downloaded AIS files")
    parser.add_argument("--processed-dir", type=str, default="./run_saved/processed_ais_outputs", help="Local directory to store converted .csv.zst files")
